...
public class ProdutoServlet extends HttpServlet {
	...
	/**
	 * @param request para poder puxar as informações do web e response para poder passar de volta
	 * @implNote Switch para o redirecionamento de métodos dentro da servlet, conforme a informação recuperada do parametro 'acao'
	 */
	@Override
